...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.divider));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.divider));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.divider));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.divider));
        }
    }
